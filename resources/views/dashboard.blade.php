...
<body>
    ...
    <div class="container">
        ...
        <img style="max-width: 50px;" class="logo" src="https://i.pinimg.com/originals/0f/8b/28/0f8b2870896edcde8f6149fe2733faaf.jpg"  alt= "logo">
...
<tr>
    ...
    <td>Profressional Working Environment 1</td>
...
<tr>
    ...
    <td rowspan="2">Profressional Skills 2</td>
...
<tr>
    <td rowspan="2">Profressional Skills 3</td>
...
<div style="font-size: 50px; background-color:darkgrey; height: 200px; text-align:center;">


    <header style= "padding: 20px; color: white; font-size: 30px;" class="header">Contact me!</header>

    <script src="https://kit.fontawesome.com/3e2ede3525.js" crossorigin="anonymous"></script>

        <a href="https://reddit.com"><i style="color:lightskyblue;" class="fab fa-reddit"></i></a>

            <a href="https://instragram.com"><i style="color:lightskyblue;" class="fab fa-instagram-square"></i></a>

                <a href="https://google.com"><i style="color:lightskyblue;" class="fab fa-google"></i></a>

                    <a href="https://linkedin.com"><i style="color:lightskyblue;" class="fab fa-linkedin"></i></a>
